function [t_out4,t_cont,t_cent,t_org]=find_centers_sq(c3,cordints,rad2,DPI,orginal_p)
...
%    imagesc(p1)
   ...
   %
   [out,out4,out4_org]=find_edge_sq(p1,orginal_p2);
   outmap=out4>10;
%    subplot(2,3,2)
%    imagesc(outmap)
%    subplot(2,3,3)
...
%    subplot(2,3,4)
   ...
   newmapbigu=find_new_map_sq(xs,ys,amirx,amiry,radiusu+32);
%    imagesc(newmap)
...
%    amiry
   ...
   %
   [ xcent_b22, ycent_b22]=optimize_square(jtest,amirx, amiry);
   amirx=xcent_b22;
   amiry=ycent_b22;
   %
