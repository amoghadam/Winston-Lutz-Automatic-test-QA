function [t_dos,t_cont,t_cent,t_org]=WL_test_v3(Scan_file_name)
i=1;
BLACK=0;
% WHITE=65530;  %16bit
WHITE=256;  %8bit
...
for i=1:10
    ...
    [asdfds,xs,ys]=newcleaner(a3(:,:,i),xcm,ycm,BIG,12);
    a6(:,:,i)=asdfds;
    CMS(i,1)=xs;
    CMS(i,2)=ys;
%     figure
...
for i=1:10
    [asdfds2,f_x,f_y]=optimize_circle_2(a6(:,:,i),CMS(i,1),CMS(i,2),BIG);
    CMS2(i,1)=f_x;
    CMS2(i,2)=f_y;
    a7(:,:,i)=asdfds2;
%     figure
...
for i=1:10
    ...
    newmap11=find_new_map(xsu,ysu,CMS2(i,1),CMS2(i,2),BIG-9);
    newmap111=(newmap1.*~newmap11);
    a8(:,:,i)=(newmap1.*a6(:,:,i));
    a88(:,:,i)=(newmap1.*a6(:,:,i))+(max(max(a8(:,:,i)))*~newmap1)+(newmap111.*a8(:,:,i));
%     figure
%     imagesc(a8(:,:,i));
...
for i=1:10
%     [asdfds2,f_x,f_y]=optimize_circle_3(a88(:,:,i),CMSS(i,1),CMSS(i,2),SML,4);
    [asdfds2,f_x,f_y,sumic]=optimize_circle_3_for_test(a88(:,:,i),CMSS(i,1),CMSS(i,2),SML,4,CMS(i,1),CMS(i,2),BIG);
    CMSS2(i,1)=f_x;
    CMSS2(i,2)=f_y;
    a11(:,:,i)=asdfds2;
%     figure
